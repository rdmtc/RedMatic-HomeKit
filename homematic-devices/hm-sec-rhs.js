module.exports = class HmSecRhs {
    constructor(config, homematic) {
        ...
        let valueContact = (ccu.values && ccu.values[datapointContact] && ccu.values[datapointContact].value) > 0 ?
        ...
        const idSubscription = ccu.subscribe({
            ...
            switch (msg.channelIndex + '.' + msg.datapoint) {
                ...
                case '1.ERROR':
                    ...
                    break;
                case '1.STATE':
                    valueContact = msg.value > 0 ? hap.Characteristic.ContactSensorState.CONTACT_NOT_DETECTED : hap.Characteristic.ContactSensorState.CONTACT_DETECTED;
